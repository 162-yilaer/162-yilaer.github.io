...
'footer.copyright': { zh: 'CopyRight © 2018 门内艺术涂料 All Rights Reserved. <br class="copyright-br">江门市门内涂料科技有限公司', en: 'CopyRight © 2018 MENNEI Artistic Coatings All Rights Reserved. <br class="copyright-br">Jiangmen MENNEI Coating Technology Co., Ltd.' },
...
'home.brand_desc1a': { zh: '不空谈美学，', en: 'No empty talk about aesthetics,' },
'home.brand_desc1b': { zh: '不赶一时潮流，', en: 'no fleeting trends,' },
'home.brand_desc2a': { zh: '以善其用心、知行合一', en: 'With sincerity and integrity as our core philosophy,' },
'home.brand_desc2b': { zh: '为品牌根本哲学，', en: 'we create an Oriental aesthetic coating brand' },
'home.brand_desc2c': { zh: '打造有温度、', en: 'with warmth,' },
'home.brand_desc2d': { zh: '有灵魂、有担当的', en: 'soul, and a sense of' },
'home.brand_desc2e': { zh: '东方美学涂料品牌。', en: 'responsibility.' },
...
'story.vision_desc': { zh: '我们不止于装饰墙面，<br class="m-br">更致力于重构当代人居生活方式。<br>以东方美学治愈都市焦虑，<br class="m-br">以健康工艺守护家人健康，<br>让每一个归家之人，<br class="m-br">都能在方寸空间里卸下疲惫、<br class="m-br">回归本真、享受自在。<br>打造精而美、有底蕴、有温度的专业艺术涂料标杆企业，成为国内东方美学艺术涂料领军品牌，<br>让东方墙面美学走进万千家庭，让传统东方智慧在现代人居中持续新生、永续传承。', en: 'We are more than wall decoration — <br class="m-br">we are committed to reshaping contemporary living.<br>Healing urban anxiety with Oriental aesthetics, <br class="m-br">protecting family health with healthy craftsmanship,<br>so that everyone returning home can let go of fatigue, return to authenticity, <br class="m-br">and enjoy freedom in their space.<br>Building a refined, beautiful, profound, and warm professional artistic coating benchmark enterprise, becoming the leading brand of Oriental aesthetic artistic coatings in China,<br>bringing Oriental wall aesthetics into thousands of homes, letting traditional Oriental wisdom continue to be reborn and inherited in modern living.' },
